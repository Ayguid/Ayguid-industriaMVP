<template>
    <div class="">
        ...
        >
            <!--location start-->
            <div class="mb-2" size="lg">
                <LocationPartialForm
                    @locationChanged="changeLocationsInForm"
                    :entity="entity"
                />
            </div>
            <!--location end-->
...
export default {
    ...
    data() {
        return {
            ...
            form: {
                ...
                country_id: this.entity?.country_id || "",
                state_id: this.entity?.state_id || "",
    ...
    methods: {
        changeLocationsInForm(event) {
            console.log(event);
            this.form.country_id = event?.selectedCountry?.id;
            this.form.state_id = event?.selectedState?.id;
            this.form.city_id = event?.selectedCity?.id;
        },
        selectCat(category) {
        ...
        debounceInput: _.debounce(function (e) {
            ...
            this.catSuggestions = this.flattenArray(
                this.$store.state.mainData.categories
