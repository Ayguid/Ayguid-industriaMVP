    ...
    <div class="">
        <div class="flex p-4 bg-light">
            <form @submit.prevent="submit()" class="flex-1 ml-4">
                ...
                <div class="">
                    <FileInput @input="uploadMedia" class=""></FileInput>
                    <div class="">
                        <div
                            :class="
                                remainingChars < 0
                        ...
                        <button :disabled="!canSubmit" type="submit" class="">
                            <div v-if="loading">
                                <svg
                                    role="status"
                                    class="
...
export default {
    ...
    methods: {
        submit() {
            ...
            //this.loading = true;            this.form.mediaIds = this.media.map((item) => item.id);
            /*
